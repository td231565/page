    ...
    if (value !== '請選擇') {
      ...
      for (let i = 0, l = json.length; i < l; i++) {
        if (value === json[i].County)
          // card.innerHTML += '<div class="card"><div class="cardHeader">空氣品質AQI</div><div class="cardContent">測站：' + json[i].SiteName + '<br>縣市：' + json[i].County + '<br>濃度：<span class="con"><b>' + json[i].Concentration + '</b></span> &mu;g/m<sup>3</sup> <img src="./src/img/help.png" class="helpIcon" /><br>監測時間：<br>' + json[i].MonitorDate + '<div class="help">PM2.5數值說明：<br><span class="low">[低]0~35：可正常戶外活動</span><br><span class="medium">[中]36~53：一般民眾正常戶外活動，敏感性族群建議減少戶外活動</span><br><span class="high">[高]54~70：若感到不適請減少戶外活動</span><br><span class="reallyhigh">[非常高]>71：應減少戶外活動</span></div></div></div>'
          card.innerHTML += `
          <div class="card">
